...
public:
	...
	//&str:	output string
	//x:	location on screen X
	//y:	location on screen Y
	...
	//usable align property is
	//		LEFT, CENTER, RIGHT, CENTER_MIDDLE, CENTER_BOTTOM, LEFT_BOTTOM, and RIGHT_BOTTOM
